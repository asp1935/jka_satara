...
@section("pageContent")
    <div class="main-content">
        ...
        <main id="main" class="main">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Add Batches</h5>
                    @if ($errors->any())
                    ...
                    <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" required id="subBranch" name="mainBranch">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="branch">Branch</label>
                                <select class="form-control" required id="subBranch" name="subBranch">
